...
// ⚡ Bolt Performance Optimization: Removed global conversationImages map and duplicate DOM to prevent O(N) recalculations on the entire list; HistoryChatItem now isolates reactivity per item.
